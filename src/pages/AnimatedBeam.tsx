...
import AnimatedLine from "@/components/SvgsComponents/AnimatedLine";
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center w-36 h-5 justify-center rounded-sm border-2 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
    ...
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Rectangle ref={div1Ref} className="-ml-[71px] w-36">
            <Icons.googleDrive />
          </Rectangle>
          <Circle ref={div5Ref}>
            <Icons.googleDocs />
