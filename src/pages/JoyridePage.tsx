...
const JoyridePage = () => {
  ...
  const steps: Step[] = [
    {
      target: ".page-header",
      content: "This is your sidebar where navigation lives.",
      disableBeacon: true,
    },
    {
      target: ".stats-cards",
    ...
    },
    {
      ...
      content: "Click here to manage settings.",
    },
    {
  ...
  return (
    <div>
      <div className="space-y-6">
        <div className="duration-500 delay-100 page-header animate-in slide-in-from-bottom-2">
          ...
          <p className="mt-2 text-gray-600 transition-colors duration-200">
            Welcome back! Here's what's happening with your features.
          </p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 gap-6 stats-cards md:grid-cols-2 lg:grid-cols-4">
          {[
            {
        ...
        <div className="grid grid-cols-1 gap-6 quick-actions lg:grid-cols-2">
          {/* Recent Activity */}
        ...
        {/* Component Status */}
        <Card className="transition-all duration-300 duration-500 component-status hover:shadow-lg animate-in slide-in-from-bottom-2 delay-400">
          <CardHeader>
            <CardTitle className="transition-colors duration-200">
              Component Status
            </CardTitle>
      ...
      <Joyride
        ...
        floaterProps={{
          ...
          styles: {
            floater: {
              marginTop: "-0.5rem", // Offset to avoid header
            },
          },
        }}
        locale={{
